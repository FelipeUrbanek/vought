...
function init() {
  ...
  if (contador == 0) {
    ...
    $('.img-hro').attr('src', 'img/captainpatria.png')
    ...
    $('.img-hro').attr('src', 'img/luzestrela.png')
    ...
    $('.img-hro').attr('src', 'img/atrain.png')
    ...
    $('.img-hro').attr('src', 'img/rainhamaeve.png')
    ...
    $('.img-hro').attr('src', 'img/profundo.png')
    ...
    $('.img-hro').attr('src', 'img/blacknoir.png')
    ...
    $('.img-hro').attr('src', 'img/translucido.png')
